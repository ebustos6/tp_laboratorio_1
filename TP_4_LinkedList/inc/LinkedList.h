...
/** \brief Permite realizar obtener un puntero al elemento que se encuentra en el indice especificado.
 *
 * \param this LinkedList* Puntero a la lista
...
/*	\brief filtra eleentos de la lista usando una funcion como criterio.
 * 	\param this LinkedList* puntero a la lista
 * 	\param (*fn) puntero a la funcion criterio
 * 	\return auxLinkedList retorna un puntero a una nueva lista filtrada.
 *
 *
 */
